...
echo "| 90   | Nvidia        | SN2010            	| Nvidia | Spectrum          | 18x25G + 4x100G         | [SONiC-ONIE-Mellanox]($(echo "${ARTF_MLNX}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-mellanox.bin/')) |" >> supported_devices_platforms.md
echo "| 91   | Nvidia        | SN2100         	| Nvidia | Spectrum          | 16x100G                 | [SONiC-ONIE-Mellanox]($(echo "${ARTF_MLNX}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-mellanox.bin/')) |" >> supported_devices_platforms.md
echo "| 92   | Nvidia        | SN2201         	| Nvidia | Spectrum          | 48x1G + 4x100G         | [SONiC-ONIE-Mellanox]($(echo "${ARTF_MLNX}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-mellanox.bin/')) |" >> supported_devices_platforms.md
...
echo "| 107   | Tencent       | TCS8400-24CC8CD    	| Broadcom    | Trident 4         | 24x200G + 8x400G        | [SONiC-ONIE-Broadcom]($(echo "${ARTF_BRCM}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-broadcom.bin/')) |" >> supported_devices_platforms.md
echo "| 108   | Tencent       | TCS9400-128CC      	| Broadcom    | Tomahawk 4        | 128x200G                | [SONiC-ONIE-Broadcom]($(echo "${ARTF_BRCM}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-broadcom.bin/')) |" >> supported_devices_platforms.md
echo "| 109   | Wistron 	  | sw-to3200k  		| Marvell     | Teralynx 7        | 32x400G              |[SONiC-ONIE-Innovium]($(echo "${ARTF_INNO}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-innovium-dbg.bin/')) |" >> supported_devices_platforms.md
echo "| 110   | Wistron 	  | 6512-32r  		    | Marvell     | Teralynx 7        | 32x400G              |[SONiC-ONIE-Innovium]($(echo "${ARTF_INNO}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-innovium-dbg.bin/')) |" >> supported_devices_platforms.md
