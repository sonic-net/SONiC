...
- [2 Modules Design](#2-modules-design)
  ...
  - [2.5 BFD state_db format example](#25-bfd-state_db-format-example)
...
- [4 Testplan](#4-testplan)
  - [4.1 Mock tests](#41-mock-tests)
  - [4.2 Mgmt tests](#42-mgmt-tests)
    - [4.2.1 Basic BGP neighbor(IPv4) with bfd monitoring](#421-basic-bgp-neighboripv4-with-bfd-monitoring)
    - [4.2.2 Basic BGP neighbor(IPv6) with bfd monitoring](#422-basic-bgp-neighboripv6-with-bfd-monitoring)
    - [4.2.3 Basic BGP neighbor(IPv6 link local address) with bfd monitoring](#423-basic-bgp-neighboripv6-link-local-address-with-bfd-monitoring)
