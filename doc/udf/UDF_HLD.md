...
| # | Item | Owner | Status |
|---|------|-------|--------|
| 1 | CLI support for UDF and UDF_SELECTOR configuration | TBD | Open |
| 2 | STATE_DB write-back on successful UDF programming | TBD | Open |
| 3 | Platform validation: confirm SAI UDF support across target ASICs | Platform vendors | Open |
