...
| /cli/show-cli-plugin   | list of string | no        | List of paths to a plugins for sonic-utilities show CLI command.        |
| /cli/config-cli-plugin | list of string | no        | List of paths to a plugins for sonic-utilities config CLI command.      |
| /cli/clear-cli-plugin  | list of string | no        | List of paths to a plugins for sonic-utilities sonic-clear CLI command. |
