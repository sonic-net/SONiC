...
Simplified Switch System Integration Program (aka S3IP) is a sub-project of the Open Data Center Committee (aka ODCC). It aims to simplify the integration of open networks and promote the development of open source ecology through the specification and open source of software and hardware.
...
3. Porting S3IP sysfs framework to platform project
 ...
 - Install the s3ip-sysfs.service on the device
    ...
    - After the platform package is uninstalled, vender should disable the s3ip-sysfs.service and remove the service file
