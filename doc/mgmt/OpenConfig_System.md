...
module: openconfig-system
  +--rw system
     ...
     |        +--ro utilized?            uint64
     |        +--ro type?                string
     |        +--ro oc-sys-ext:inodes-available?   uint64
     |        +--ro oc-sys-ext:inodes-total?       uint64
     |        +--ro oc-sys-ext:read-only?          boolean
     +--rw aaa
     |  +--rw authentication
     |  |  +--rw config
...
3. Add support for following System features:
    ...
    * messages
    * alarms
    * mount-points (including openconfig-system-ext leaves)
    * memory
    * cpus
    * grpc-servers
    * gnmi-pathz-policies
...
| type | - | - | Type |
| oc-sys-ext:inodes-available | openconfig-system-ext.yang | STATE_DB | InodeAvailable |
| oc-sys-ext:inodes-total | openconfig-system-ext.yang | STATE_DB | InodeTotal |
| oc-sys-ext:read-only | openconfig-system-ext.yang | STATE_DB | ReadOnly |
| **clock** | | | |
...
5. system/mount-points - Extension leaves `oc-sys-ext:inodes-available`, `oc-sys-ext:inodes-total`, and `oc-sys-ext:read-only` are provided via the `openconfig-system-ext` module. Upstream contribution: [openconfig/public#1519](https://github.com/openconfig/public/pull/1519).
...
13. Verify that operations supported for gNMI/REST works fine for mount-points nodes (including oc-sys-ext:inodes-available, oc-sys-ext:inodes-total, oc-sys-ext:read-only).
