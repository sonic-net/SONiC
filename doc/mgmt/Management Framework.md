# DRAFT: SONiC Management Framework
...
4. App module uses the APIs provided by the DB access layer, along with object translation instructions provided by the YANG annotations, to read and write data into the Redis DB.
