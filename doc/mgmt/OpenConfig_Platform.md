...
- Previous implementation supported only EEPROM component using a custom app approach. This implementation uses the common transformer approach and extends support to all listed component types.
