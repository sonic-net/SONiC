...
o	You could have your build pipeline push docker images to your registry or ACR (Azure Container Registry)
o	For intended updates, publish manifests
o	With node selector labels (optionally)
o	With image pull secrets provided
o	You may create secret to access your repo and make it default across all
