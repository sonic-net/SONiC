...
| Jun 11, 5:30–6:30 PM | Cross-reference related PRs and HLDs | Update the HLD to **reference and list all related PRs and HLDs** for centralized chassis work (per Sunesh's suggestion). | Resolved — [§13.1 Centralized chassis references](#131-centralized-chassis-references) |
...
| Jun 11, 5:30–6:30 PM | Add BFD offload and LC CPU control-plane section | Add a section/reference on **BFD offload support** and **line card CPU involvement** for control packets. | Out of scope for Phase 1 |
...
| Jun 11, 5:30–6:30 PM | Plan port channel, VLAN, and LAG support | Update the HLD with analysis and handling of **port channel**, **VLAN**, and **LAG support** in **future phases**. | Out of scope for Phase 1 |
