...
- [CONFIG_DB](#config-db)
  ...
  - [`PON_OLT_PROTECTION_GROUP`](#pon-olt-protection-group)
  - [`PON_ONU`](#pon-onu)
...
- [STATE_DB](#state-db)
  ...
  - [`PON_OLT_PROTECTION_GROUP_STATE`](#pon-olt-protection-group-state)
...
module: sonic-pon
  +--rw sonic-pon
     ...
     +--rw PON_OLT_INTF
     |  +--rw PON_OLT_INTF_LIST* [olt-intf-name]
     |     +--rw olt-intf-name                         string
     |     +--rw device-id?                            string
     ...
     |  +--rw PON_OLT_INTF_NETWORK_LIST* [olt-intf-name vlan-id]
     |     +--rw olt-intf-name           -> /sonic-pon/PON_OLT_INTF/PON_OLT_INTF_LIST/olt-intf-name
     ...
     +--rw PON_OLT_INTF_ONU
     |  +--rw PON_OLT_INTF_ONU_LIST* [olt-intf-name onu-serial-number]
     |     +--rw olt-intf-name        -> /sonic-pon/PON_OLT_INTF/PON_OLT_INTF_LIST/olt-intf-name
     |     +--rw onu-serial-number    string
     |     +--rw onu-id?              uint16
     |     +--rw disable?             boolean
     +--rw PON_OLT_INTF_ONU_OLT_SERVICE
     |  +--rw PON_OLT_INTF_ONU_OLT_SERVICE_LIST* [olt-intf-name onu-serial-number service-port-id]
     |     +--rw olt-intf-name        -> /sonic-pon/PON_OLT_INTF/PON_OLT_INTF_LIST/olt-intf-name
     ...
     |  +--rw PON_OLT_INTF_ONU_SERVICE_TCONT_LIST* [olt-intf-name onu-serial-number olt-service-id]
     |     +--rw olt-intf-name        -> /sonic-pon/PON_OLT_INTF/PON_OLT_INTF_LIST/olt-intf-name
     |     +--rw onu-serial-number    -> /sonic-pon/PON_OLT_INTF_ONU/PON_OLT_INTF_ONU_LIST/onu-serial-number
     |     +--rw olt-service-id       uint32
     |     +--rw alloc-id?            uint16
     +--rw PON_OLT_INTF_ONU_SERVICE_GEMPORT
     |  +--rw PON_OLT_INTF_ONU_SERVICE_GEMPORT_LIST* [olt-intf-name onu-serial-number olt-service-id]
     |     +--rw olt-intf-name        -> /sonic-pon/PON_OLT_INTF/PON_OLT_INTF_LIST/olt-intf-name
     |     +--rw onu-serial-number    -> /sonic-pon/PON_OLT_INTF_ONU/PON_OLT_INTF_ONU_LIST/onu-serial-number
     |     +--rw olt-service-id       uint32
     ...
     |     +--rw olt-name              -> /sonic-pon/PON_OLT_INTF/PON_OLT_INTF_LIST/olt-intf-name
     |     +--rw debug-log-level?      spt:logging-level
     |     +--rw fw-bank-ptr?          uint16
     |     +--rw nni-max-frame-size?   uint32
     +--rw PON_OLT_PROTECTION_GROUP
     |  +--rw PON_OLT_PROTECTION_GROUP_LIST* [group-name]
     |     +--rw group-name                  string
     |     +--rw admin-status?               boolean
     |     +--rw working-interface?          -> /sonic-pon/PON_OLT_INTF/PON_OLT_INTF_LIST/olt-intf-name
     |     +--rw protection-olt?             string
     |     +--rw protection-olt-interface?   string
     |     +--rw coordination-mode?          enumeration
     ...
     |  +--ro PON_OLT_INTF_STATE_LIST* [olt-intf-name]
     |     +--ro olt-intf-name                         string
     |     +--ro timestamp?                            yang:date-and-time
     ...
     |  +--ro PON_OLT_INTF_ONU_STATE_LIST* [olt-intf-name onu-serial-number]
     |     +--ro olt-intf-name        -> /sonic-pon/PON_OLT_INTF_STATE/PON_OLT_INTF_STATE_LIST/olt-intf-name
     |     +--ro onu-serial-number    string
     |     +--ro onu-id?              uint16
     |     +--ro disable?             boolean
     +--ro PON_OLT_INTF_ONU_FW_UPGRADE_STATE
     |  +--ro PON_OLT_INTF_ONU_FW_UPGRADE_STATE_LIST* [olt-intf-name onu-serial-number]
     |     +--ro olt-intf-name        -> /sonic-pon/PON_OLT_INTF_ONU_STATE/PON_OLT_INTF_ONU_STATE_LIST/olt-intf-name
     |     +--ro onu-serial-number    string
     +--ro PON_OLT_INTF_ONU_OPERATIONAL_STATE
     |  +--ro PON_OLT_INTF_ONU_OPERATIONAL_STATE_LIST* [olt-intf-name id]
     |     +--ro olt-intf-name        -> /sonic-pon/PON_OLT_INTF_ONU_STATE/PON_OLT_INTF_ONU_STATE_LIST/olt-intf-name
     |     +--ro id                   string
     |     +--ro operational-state?   enumeration
     +--ro PON_OLT_INTF_NETWORK_STATE
     |  +--ro PON_OLT_INTF_NETWORK_STATE_LIST* [olt-intf-name vlan-id]
     |     +--ro olt-intf-name                                        -> /sonic-pon/PON_OLT_INTF_STATE/PON_OLT_INTF_STATE_LIST/olt-intf-name
     ...
     |  +--ro PON_OLT_INTF_NNI_NETWORK_LEARNING_TABLE_STATE_LIST* [olt-intf-name network-id mac-address]
     |     +--ro olt-intf-name    -> /sonic-pon/PON_OLT_INTF_STATE/PON_OLT_INTF_STATE_LIST/olt-intf-name
     ...
     |  +--ro PON_OLT_INTF_ONU_SERVICE_TCONT_STATE_LIST* [olt-intf-name onu-serial-number service-port-id]
     |     +--ro olt-intf-name        -> /sonic-pon/PON_OLT_INTF_STATE/PON_OLT_INTF_STATE_LIST/olt-intf-name
     ...
     |  +--ro PON_OLT_INTF_ONU_SERVICE_GEMPORT_STATE_LIST* [olt-intf-name onu-serial-number service-port-id]
     |     +--ro olt-intf-name        -> /sonic-pon/PON_OLT_INTF_STATE/PON_OLT_INTF_STATE_LIST/olt-intf-name
     |     +--ro onu-serial-number    -> /sonic-pon/PON_OLT_INTF_ONU_STATE/PON_OLT_INTF_ONU_STATE_LIST/onu-serial-number
     |     +--ro service-port-id      uint32
     ...
     +--ro PON_OLT_PROTECTION_GROUP_STATE
     |  +--ro PON_OLT_PROTECTION_GROUP_STATE_LIST* [group-name]
     |     +--ro group-name              string
     |     +--ro active-olt?             string
     |     +--ro active-olt-interface?   string
     |     +--ro protection-state?       enumeration
     |     +--ro last-failover-reason?   string
     |     +--ro last-failover-time?     yang:date-and-time
     ...
     |  +--ro PON_OLT_INTF_STATISTICS_BINNED_LIST* [olt-intf-name olt-stats-id]
     |     +--ro olt-intf-name                  -> /sonic-pon/PON_OLT_INTF_STATE/PON_OLT_INTF_STATE_LIST/olt-intf-name
     ...
     |     +--ro olt-name         -> /sonic-pon/PON_OLT_INTF_STATE/PON_OLT_INTF_STATE_LIST/olt-intf-name
     ...
     |  +--ro PON_ONU_OLT_SERVICE_NETWORK_STATE_LIST* [onu-name olt-service-id vlan-id]
     |     +--ro onu-name          -> /sonic-pon/PON_ONU_STATE/PON_ONU_STATE_LIST/onu-name
     |     +--ro olt-service-id    -> /sonic-pon/PON_ONU_OLT_SERVICE_STATE/PON_ONU_OLT_SERVICE_STATE_LIST/olt-service-id
     |     +--ro network-id?       uint16
     |     +--ro vlan-id           uint16
     ...
     +--ro PON_OLT_PLUG_STATE
        +--ro PON_OLT_PLUG_STATE_LIST* [name]
           +--ro name                          -> /sonic-pon/PON_OLT_INTF_STATE/PON_OLT_INTF_STATE_LIST/olt-intf-name
           +--ro fw-bank-ptr?                  uint16
           +--ro fw-version?                   string
           +--ro hardware-version?             string
           +--ro manufacturer?                 string
...
| --- | --- | --- |
| `controller-name` *(key)* | string (length 0..256) | Name identifier to reference this PON Controller. |
...
| `create-date` | yang:date-and-time | User configurable timestamp to record the date and time of when device was created. |
| `olt-timeout` | uint32 (default 300) | The amount of time for OLT plug to be locked to a controller. If an OLT plug doesn't receive OAM from the PON Controller in this time period, it will release its lock to allow another PON controller to manage it. |
...
| `refresh-state-on-olt-change` | boolean (default false) | When true, the PON Controller detects OLT plug changes by comparing the OLT-G OMCI ME 'equipment_id' attribute and performs a MIB Upload to refresh the current MIB data when a change is detected. |

### `PON_DOWNSTREAM_QOS_MAP_MAP`

- **Key:** `name`, `cos`
- **Description:** Mapping entry that classifies VLAN CoS bit values to a destination GPON XGEM Port (OLT-Service) offset.

| Field | Type | Description |
| --- | --- | --- |
| `name` *(key)* | string |  |
| `cos` *(key)* | uint8 (range 0..7) | VLAN CoS/Priority bit value for this classifier. |
| `olt-service-offset` | uint8 (range 0..7) | Destination GPON XGEM Port offset that the start/end CoS values are classified to. |

### `PON_OLT_INTF`

- **Key:** `olt-intf-name`
- **Description:** List of OLT interfaces. ConfigDB key: PON_OLT_INTF\|<olt-intf-name>.

| Field | Type | Description |
| --- | --- | --- |
| `olt-intf-name` *(key)* | string (length 0..256) | Name identifier to reference this OLT interface. |
| `device-id` | string | OLT interface identifier (OLT interface MAC Address or 'Default'). |
| `port-id` | leafref → name (mandatory) |  |
...
| `encryption` | olt-encryption-mode (enum: disabled, bidirectional, broadcast, downstream; default disabled) | Enable the OLT interface for PON MAC layer encryption of data. |
...
- **Key:** `olt-intf-name`, `vlan-id`
- **Description:** List of networks to pre-define.

| Field | Type | Description |
| --- | --- | --- |
| `olt-intf-name` *(key)* | leafref → olt-intf-name | References PON_OLT_INTF_LIST. |
...
- **Key:** `olt-intf-name`, `onu-serial-number`
- **Description:** For each ONU (defined by Vendor ID + Vendor SN) and service port on the ONU, the Allocation ID to use for the service port. Use 65535 or don't specify for automatic assignment.

| Field | Type | Description |
| --- | --- | --- |
| `olt-intf-name` *(key)* | leafref → olt-intf-name | References PON_OLT_INTF_LIST. |
| `onu-serial-number` *(key)* | string (length 0..256) | ONU serial number (defined by Vendor ID + Vendor SN). |
| `onu-id` | uint16 (range 1..128) | The allocation ID, XGEM port ID, and ONU ID number assigned to this ONU for carry OMCI management messages. |
...
- **Key:** `olt-intf-name`, `onu-serial-number`, `service-port-id`
...
| `unicast-id` | uint16 (range 1154..1278 \| 1280..1534) | The Allocation ID to use for the service port. Use 65535 or don't specify for automatic assignment. Valid ALLOC-ID range is 1154..1534, excluding 1279. |

### `PON_OLT_INTF_ONU_SERVICE_GEMPORT`

- **Key:** `olt-intf-name`, `onu-serial-number`, `olt-service-id`
...
| `onu-serial-number` *(key)* | leafref → onu-serial-number | References PON_OLT_INTF_ONU_LIST. |
| `olt-service-id` *(key)* | uint32 (range 0..7) | OLT Service port number. |
| `alloc-id` | uint16 (range 1154..1278 \| 1280..1534) | The Allocation ID to use for the service port. Use 65535 or don't specify for automatic assignment. Valid ALLOC-ID range is 1154..1534, excluding 1279. |
...
| Field | Type | Description |
| --- | --- | --- |
| `olt-name` *(key)* | leafref → olt-intf-name | References PON_OLT_INTF_LIST. |
| `debug-log-level` | logging-level (enum: emergency, alert, critical, error, warning, notice, …; default disable) | Enables debug logging for this OLT plug. |
| `fw-bank-ptr` | uint16 (range 0..3\|65535; default 65535) | Firmware pointer to select bank (0 to 3) to be active on OLT plug. When this value changes, the OLT plug will be reset to load the firmware in the bank. |
| `nni-max-frame-size` | uint32 (range 1518..12500; default 9600) | Maximum number of frame bytes from the DA to CRC32 for NNI receive path. (XGSPON-1518 to 9600). |
...
| Field | Type | Description |
| --- | --- | --- |
| `olt-name` *(key)* | leafref → olt-name | References PON_OLT_PLUG_LIST. |
...
### `PON_OLT_PROTECTION_GROUP`

- **Key:** `group-name`
- **Description:** List of OLT PON protection groups.

| Field | Type | Description |
| --- | --- | --- |
| `group-name` *(key)* | string (length 0..256) | Name identifier used to reference this PON protection group. |
| `admin-status` | boolean (default true) | Enables this PON protection group. |
| `working-interface` | leafref → olt-intf-name | References PON_OLT_INTF_LIST. |
| `protection-olt` | string (length 0..256) | References a peer OLT that that contains protection PON interface. Optional: this attribute is not required to be set if the protection interface on the local OLT. |
| `protection-olt-interface` | string (length 0..256) | References a peer OLT interface that that contains protection PON interface. |
| `coordination-mode` | enumeration (enum: stateful, stateless; default stateful) | PON protection coordination mode. |
| `revertive` | boolean (default false) | Auto revert when primary OLT interface recovers. |
...
| Field | Type | Description |
| --- | --- | --- |
| `onu-name` *(key)* | string (length 0..256) | Name identifier to reference this ONU device. |
| `device-id` | string (length 0..256; mandatory) | ONU device identifier (XGS-PON: Vendor + SSN, or 'Default'). |
...
| `service-config` | string (length 0..64; units 'Disabled' or 'Add CTag' or 'Unmodified' or <Service Config Name>; default Disabled) | ONU Service Configuration has 3 generic built-in modes and the ability to load a service configuration from the database. XGS supports all 3 configurations and service configuration files. |
| `service-config-omci-stats` | boolean (default false) | When set to true, no OMCI PM MEs will be automatically configured by the Controller. The PM MEs need to be specified in the ONU's SRV-CFG file. |
| `fw-upgrade-backoff-delay` | uint32 (range 1..10; units seconds; default 5) | Time to wait before retransmitting a window. |
...
| `fw-upgrade-end-download-timeout` | uint32 (range 0..600; units seconds; default 0) | Time to wait for the final acknowledgement during firmware upgrade. Increase the value to allow the ONU additional time to write the firmware image to flash. The PON Controller automatically calculates the end-download-timeout when set to a value of zero. |
...
- **Description:** XGS-PON: firmware source filenames for bank 0 (1st in list) and bank 1 if version doesn't match.
...
- **Description:** OLT Configuration for the services. 0 to 7 services can be configured. A service is an XGEM Port ID/Alloc ID in XGS-PON.
...
| `poe` | boolean (default false) | Enable Power over Ethernet (PoE) on the UNI port. |
...
| Field | Type | Description |
| --- | --- | --- |
| `sla-profile-name` *(key)* | string (length 0..256) | Name identifier to reference this SLA profile. |
...
| Field | Type | Description |
| --- | --- | --- |
| `name` *(key)* | string | Name identifier to reference this PON Controller. |
| `timestamp` | yang:date-and-time | The last update for this state file. |
...
| `refresh-state-on-olt-change` | boolean | Current state of refresh state on OLT plug change. |

### `PON_CONTROLLER_SYSTEM_STATUS_OLT`

- **Key:** `controller-name`, `mac-address`
- **Description:** The list of OLT plugs currently registered on this PON Controller.

| Field | Type | Description |
| --- | --- | --- |
| `controller-name` *(key)* | string | References PON_CONTROLLER_SYSTEM_STATUS_LIST. |
| `mac-address` *(key)* | yang:mac-address | OLT plug MAC address. |
| `olt-state` | string | The current state of the OLT plug. |
| `onu-active-count` | uint32 | The number of ONUs that are active on this OLT plug. |
...
| `onu-serial-number` *(key)* | string | ONU serial number (defined by Vendor ID + Vendor SN). |
...
| Field | Type | Description |
| --- | --- | --- |
| `olt-intf-name` *(key)* | leafref → olt-intf-name | References PON_OLT_INTF_STATE_LIST. |
...
| `pon-flood-id` | uint16 | XGEM Port ID for unknown/multicast/broadcast frames from this network. |
| `vlan-id` *(key)* | uint16 (range 0..4095) | VLAN id used to identify packets on the NNI network. |
...
- **Key:** `olt-intf-name`, `network-id`, `mac-address`
- **Description:** The MAC address learning table for this uplink port. A list of MAC Addresses and source XGEM port IDs (XGS-PON).

| Field | Type | Description |
| --- | --- | --- |
| `olt-intf-name` *(key)* | leafref → olt-intf-name | References PON_OLT_INTF_STATE_LIST. |
| `network-id` *(key)* | leafref → network-id | References PON_OLT_INTF_NETWORK_STATE_LIST. |
| `mac-address` *(key)* | yang:mac-address | MAC address of the learned CPE. |
| `unicast-id` | uint16 | XGEM Port ID that the CPE was learned on. |
...
| `onu-serial-number` *(key)* | leafref → onu-serial-number | References PON_OLT_INTF_ONU_STATE_LIST. |
| `service-port-id` *(key)* | uint32 | OLT Service port number. |
| `alloc-id` | uint16 | Allocation ID and XGEM Port ID used on this service port. |
...
| `olt-intf-name` *(key)* | leafref → olt-intf-name | References PON_OLT_INTF_STATE_LIST. |
| `onu-serial-number` *(key)* | string | ONU serial number (defined by Vendor ID + Vendor SN). |
| `onu-id` | uint16 | The allocation ID, XGEM port ID, and ONU ID number assigned to this ONU for carry OMCI management messages. |
| `disable` | boolean | When true, the disable serial number PLOAM message will be sent to this ONU if it tries to register. |

### `PON_OLT_INTF_STATE`

- **Key:** `olt-intf-name`
- **Description:** List of OLT interfaces. StateDB key: PON_OLT_INTF_STATE\|<olt-intf-name>.

| Field | Type | Description |
| --- | --- | --- |
| `olt-intf-name` *(key)* | string | Name identifier to reference this OLT interface. |
| `timestamp` | yang:date-and-time | The last update for this state file. |
| `fiber-reach` | enumeration (enum: extended-0to40km, extended-40to60km, extended-20to40km, extended-10to30km, short, standard, …) | The current fiber reach configured on this OLT interface. |
| `laser-shutdown` | string | Indicates the cause of a laser shutdown. |
| `loss-of-signal` | boolean | There are no ONUs registered on the OLT interface. |
| `pon-enable` | boolean | Current state of PON Optics on the module. |
| `discovery-period` | uint32 | Current OLT interface discovery time interval. |
| `downstream-fec` | boolean | Current Forward Error Correction in the downstream direction. |
| `encryption` | olt-encryption-mode (enum: disabled, bidirectional, broadcast, downstream) | Current OLT interface PON MAC layer encryption mode. |
...
| `mac-address` | yang:mac-address | GPON MAC Address. |
...
- **Key:** `name`
- **Description:** Firmware upgrade status. If a firmware upgrade is currently in-progress, the current status is reported. Otherwise, the status is reported for the last firmware upgrade performed for this OLT plug.

| Field | Type | Description |
| --- | --- | --- |
| `name` *(key)* | leafref → name | References PON_OLT_PLUG_STATE_LIST. |
| `bank` | uint16 | Last firmware bank number (software download ME ID) firmware was downloaded to. |
| `fx-code` | uint32 | OLT plug Software Download error code. |
| `file` | string | Name of the file to download. |
| `status` | string | Software download status (Downloading, Success, Failed). |
| `upgrade-duration` | string | Length of time in hours, minutes, and seconds for the OLT plug upgrade to complete. |
| `upgrade-time` | yang:date-and-time | Timestamp reporting time the OLT plug was upgraded. |
...
| Field | Type | Description |
| --- | --- | --- |
| `name` *(key)* | leafref → olt-intf-name | References PON_OLT_INTF_STATE_LIST. |
...
| `online-time` | yang:date-and-time | The last time the Controller successfully completed configuration of the OLT. |
...
| `fw-upgrade-fx-code` | uint32 | OLT plug Software Download error code. |
...
| `fw-upgrade-duration` | string | Length of time in hours, minutes, and seconds for the OLT plug upgrade to complete. |
| `fw-upgrade-time` | yang:date-and-time | Timestamp reporting time the OLT plug was upgraded. |
| `hw-failure` | string | Current hardware failure status. |

### `PON_OLT_PROTECTION_GROUP_STATE`
...
| Field | Type | Description |
| --- | --- | --- |
| `group-name` *(key)* | string | Name identifier used to reference this PON protection group. |
| `active-olt` | string | References the OLT that contains active PON protection interface. |
| `active-olt-interface` | string | References the active PON protection interface on the local or peer OLT. |
| `protection-state` | enumeration (enum: working, protection, degraded) | Current PON protection state of this group. |
| `last-failover-reason` | string | Reason for the last PON protection switchover. |
| `last-failover-time` | yang:date-and-time | Timestamp of the last PON protection switchover. |
...
| `olt-service-offset` | uint8 | Destination GPON XGEM Port offset that the start/end CoS values are classified to. |
...
| `onu-name` *(key)* | leafref → onu-name | References PON_ONU_STATE_LIST. |
| `olt-service-id` *(key)* | leafref → olt-service-id | References PON_ONU_OLT_SERVICE_STATE_LIST. |
| `network-id` | uint16 | Index for this entry. |
| `vlan-id` *(key)* | uint16 (range 0..4095) | VLAN ID. |
...
| Field | Type | Description |
| --- | --- | --- |
| `onu-name` *(key)* | string | Name identifier to reference this ONU device. |
| `timestamp` | yang:date-and-time | The last update for this state file. |
| `onu-id` | uint16 | ONU ID used on the PON. |
| `cvid` | uint16 | VID for Add CTag service configuration. |
| `equipment-id` | string | Equipment ID as reported by the ONU through G.988 ONU-G. |
| `fw-bank-ptr` | uint16 | Current value of the firmware bank pointer. |
| `fw-version` | string | Current firmware running on the ONU. |
| `hardware-version` | string | Hardware version reported by the ONU. |
| `last-provisioning-time` | yang:date-and-time | The last time the Controller completed provisioning service for the ONU. |
| `mac-address` | yang:mac-address | MAC Address for this ONU. |
| `manufacturer` | string | Manufacturer of the ONU. |
| `model` | string | Model name for the ONU. |
| `online-time` | yang:date-and-time | The last time the ONU successfully completed registration with the OLT. |
| `realtime-stats` | boolean | Enables the ONU state files to show all statistics on every cycle. |
| `registration-id` | string | ID used for this ONU during PLOAM registration. This value is sometimes used to authenticate the ONU. |
| `alloc-id-omcc` | uint16 | ONU ID used on the PON. |
| `host-mac-address` | yang:mac-address | MAC Address of the IP Host running on this ONU. |
...
| `omcc-version` | yang:hex-string | This attribute identifies the version of the OMCC protocol being used by the ONU. |
...
| `registration-id-hex` | yang:hex-string | 72-character (36-byte) hex-string Registration ID for this ONU. |
...
| `fw-upgrade-end-download-timeout` | uint32 (units seconds) | Time to wait for the final acknowledgement during firmware upgrade. Increase the value to allow the ONU additional time to write the firmware image to flash. The PON Controller automatically calculates the end-download-timeout when set to a value of zero. |
...
| `upgrade-time` | yang:date-and-time | Timestamp reporting time the ONU was upgraded. |
...
| `poe` | boolean | Power over Ethernet (PoE) status for the UNI port. |
...
- **Key:** `olt-intf-name`, `olt-stats-id`
- **Description:** List containing the statistics history for this device.

| Field | Type | Description |
| --- | --- | --- |
| `olt-intf-name` *(key)* | leafref → olt-intf-name | References PON_OLT_INTF_STATE_LIST. |
| `olt-stats-id` *(key)* | yang:date-and-time | Timestamp when the statistics were collected. |
| `timestamp` | yang:date-and-time | Timestamp when the statistics were collected. |
...
| Field | Type | Description |
| --- | --- | --- |
| `olt-name` *(key)* | leafref → olt-intf-name | References PON_OLT_INTF_STATE_LIST. |
...
- **Key:** `olt-name`, `olt-stats-id`
- **Description:** OLT plug NNI port statistics.
...
- **Key:** `olt-name`, `olt-stats-id`
- **Description:** OLT plug device temperatures.
...
| --- | --- | --- |
| `olt-name` *(key)* | leafref → olt-intf-name | References PON_OLT_INTF_STATE_LIST. |
| `olt-id` *(key)* | uint16 | OLT PON Flood ID (GPON: Multicast XGEM Port ID). |
...
- **Key:** `olt-name`
- **Description:** OLT plug temperatures.
...
| `olt-name` *(key)* | leafref → olt-intf-name | References PON_OLT_INTF_STATE_LIST. |
| `olt-stats-id` *(key)* | leafref → olt-stats-id | References PON_OLT_INTF_STATISTICS_BINNED_LIST. |
| `flood-id` *(key)* | uint16 | OLT PON Flood ID (GPON: Multicast XGEM Port ID). |
| `tx-bw-best-effort-sla-util` | uint64 | Transmit BW Best Effort SLA Util. |
| `tx-bw-best-effort-sla-bps` | uint64 | Transmit BW Best Effort SLA bps. |
| `tx-bw-guaranteed-sla-util` | uint64 | Transmit BW Guaranteed SLA Util. |
| `tx-bw-guaranteed-sla-bps` | uint64 | Transmit BW Guaranteed SLA bps. |
...
| `equalization-delay` | uint64 (units upstream-slots(12.8ns)) | Equalization delay assigned by the OLT to an ONU to ensure that the ONU's transmissions are aligned on a common upstream time reference. |
| `round-trip-time` | uint64 (units TQ(16ns)) | Calculated Route Trip Time (RTT) between the OLT and ONU. |
...
| `olt-pon-equalization-delay` | uint64 (units upstream-slots(12.8ns)) | Equalization delay assigned by the OLT to an ONU to ensure that the ONU's transmissions are aligned on a common upstream time reference. |
| `olt-pon-round-trip-time` | uint64 (units TQ(16ns)) | Calculated Route Trip Time (RTT) between the OLT and ONU. |
...
| `onu-stats-id` *(key)* | yang:date-and-time | Timestamp identifying the statistics collection period. |
| `timestamp` | yang:date-and-time | Timestamp when the statistics were collected. |
