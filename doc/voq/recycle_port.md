...
Two recycle ports, Ethernet-Rec0 and Ethernet-Rec1, are configured in the example port_config.ini below. Ethernet-Rec0 is used to recycle packet to be routed, which has port role Rec. Ethernet-Rec1 is used as inband port and thus its port role is set to Inb.
