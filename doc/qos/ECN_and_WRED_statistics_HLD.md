...
Following new port counters will be added along with existing counters on supported platforms
...
For every egress queue, following statistics will be added along with existing queue conters on supported platforms
