...
| :---- | :---- | :---- | :---- | :---- | :---- |
| T | T | T | Pause Duration \+= Time since last poll Recent Time \+= Time since last poll |  | Timestep 8 |
| T | T | F | Pause Duration \+= Time since last poll Recent Time \+= Time since last poll On2Off Transitions \++ |  | Timestep 3 |
| T | F | T | Pause Duration \+= Time since last poll Recent Time \+= Time since last poll | Using RX counters only can't pick this up Unlikely to happen, polling interval would have to be 10s of MS | Timestep 11 |
| T | F | F | On2Off Transitions \++ |  | Timestep  6 |
| F | T | T | Total Time \+= Time since last poll Recent Time \+= Time since last poll Recent Timestamp \= Time at last poll |  | Timestep  2 |
| F | T | F | Total Time \+= Time since last poll Recent Time \+= Time since last poll Recent Timestamp \= Time at last poll On2Off Transitions \++ | Using RX counters only can't pick this up Benefits pause status because it will have a more accurate depiction of recent activity and number of transitions | Timestep 4 |
