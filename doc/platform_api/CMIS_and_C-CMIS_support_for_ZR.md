...
##### 2.1.3 Transceiver DOM Threshold Table #####
    ...
    lasertemphighalarm           = FLOAT                            ; laser temperature high alarm threshold
    lasertemplowalarm            = FLOAT                            ; laser temperature low alarm threshold
    lasertemphighwarning         = FLOAT                            ; laser temperature high warning threshold
    lasertemplowwarning          = FLOAT                            ; laser temperature low warning threshold
    ...
    biasxihighalarm              = FLOAT                            ; bias xi high alarm threshold
    biasxilowalarm               = FLOAT                            ; bias xi low alarm threshold
    biasxihighwarning            = FLOAT                            ; bias xi high warning threshold
    biasxilowwarning             = FLOAT                            ; bias xi low warning threshold
    biasxqhighalarm              = FLOAT                            ; bias xq high alarm threshold
    biasxqlowalarm               = FLOAT                            ; bias xq low alarm threshold
    biasxqhighwarning            = FLOAT                            ; bias xq high warning threshold
    biasxqlowwarning             = FLOAT                            ; bias xq low warning threshold
    biasxphighalarm              = FLOAT                            ; bias xp high alarm threshold
    biasxplowalarm               = FLOAT                            ; bias xp low alarm threshold
    biasxphighwarning            = FLOAT                            ; bias xp high warning threshold
    biasxplowwarning             = FLOAT                            ; bias xp low warning threshold
    biasyihighalarm              = FLOAT                            ; bias yi high alarm threshold
    biasyilowalarm               = FLOAT                            ; bias yi low alarm threshold
    biasyihighwarning            = FLOAT                            ; bias yi high warning threshold
    biasyilowwarning             = FLOAT                            ; bias yi low warning threshold
    biasyqhighalarm              = FLOAT                            ; bias yq high alarm threshold
    biasyqlowalarm               = FLOAT                            ; bias yq low alarm threshold
    biasyqhighwarning            = FLOAT                            ; bias yq high warning threshold
    biasyqlowwarning             = FLOAT                            ; bias yq low warning threshold
    biasyphighalarm              = FLOAT                            ; bias yp high alarm threshold
    biasyplowalarm               = FLOAT                            ; bias yp low alarm threshold
    biasyphighwarning            = FLOAT                            ; bias yp high warning threshold
    biasyplowwarning             = FLOAT                            ; bias yp low warning threshold
    cdshorthighalarm             = FLOAT                            ; cd short high alarm threshold
    cdshortlowalarm              = FLOAT                            ; cd short low alarm threshold
    cdshorthighwarning           = FLOAT                            ; cd short high warning threshold
    cdshortlowwarning            = FLOAT                            ; cd short low warning threshold
    cdlonghighalarm              = FLOAT                            ; cd long high alarm threshold
    cdlonglowalarm               = FLOAT                            ; cd long low alarm threshold
    cdlonghighwarning            = FLOAT                            ; cd long high warning threshold
    cdlonglowwarning             = FLOAT                            ; cd long low warning threshold
    dgdhighalarm                 = FLOAT                            ; dgd high alarm threshold
    dgdlowalarm                  = FLOAT                            ; dgd low alarm threshold
    dgdhighwarning               = FLOAT                            ; dgd high warning threshold
    dgdlowwarning                = FLOAT                            ; dgd low warning threshold
    sopmdhighalarm               = FLOAT                            ; sopmd high alarm threshold
    sopmdlowalarm                = FLOAT                            ; sopmd low alarm threshold
    sopmdhighwarning             = FLOAT                            ; sopmd high warning threshold
    sopmdlowwarning              = FLOAT                            ; sopmd low warning threshold
    pdlhighalarm                 = FLOAT                            ; pdl high alarm threshold
    pdllowalarm                  = FLOAT                            ; pdl low alarm threshold
    pdlhighwarning               = FLOAT                            ; pdl high warning threshold
    pdllowwarning                = FLOAT                            ; pdl low warning threshold
    osnrhighalarm                = FLOAT                            ; osnr high alarm threshold
    osnrlowalarm                 = FLOAT                            ; osnr low alarm threshold
    osnrhighwarning              = FLOAT                            ; osnr high warning threshold
    osnrlowwarning               = FLOAT                            ; osnr low warning threshold
    esnrhighalarm                = FLOAT                            ; esnr high alarm threshold
    esnrlowalarm                 = FLOAT                            ; esnr low alarm threshold
    esnrhighwarning              = FLOAT                            ; esnr high warning threshold
    esnrlowwarning               = FLOAT                            ; esnr low warning threshold
    cfohighalarm                 = FLOAT                            ; cfo high alarm threshold
    cfolowalarm                  = FLOAT                            ; cfo low alarm threshold
    cfohighwarning               = FLOAT                            ; cfo high warning threshold
    cfolowwarning                = FLOAT                            ; cfo low warning threshold
    txcurrpowerhighalarm         = FLOAT                            ; txcurrpower high alarm threshold
    txcurrpowerlowalarm          = FLOAT                            ; txcurrpower low alarm threshold
    txcurrpowerhighwarning       = FLOAT                            ; txcurrpower high warning threshold
    txcurrpowerlowwarning        = FLOAT                            ; txcurrpower low warning threshold
    rxtotpowerhighalarm          = FLOAT                            ; rxtotpower high alarm threshold
    rxtotpowerlowalarm           = FLOAT                            ; rxtotpower low alarm threshold
    rxtotpowerhighwarning        = FLOAT                            ; rxtotpower high warning threshold
    rxtotpowerlowwarning         = FLOAT                            ; rxtotpower low warning threshold
    rxsigpowerhighalarm          = FLOAT                            ; rxsigpower high alarm threshold
    rxsigpowerlowalarm           = FLOAT                            ; rxsigpower low alarm threshold
    rxsigpowerhighwarning        = FLOAT                            ; rxsigpower high warning threshold
    rxsigpowerlowwarning         = FLOAT                            ; rxsigpower low warning threshold
...
##### 2.1.4 Transceiver Status Table #####
    ...
    prefecberhighalarm_flag      = FLOAT                            ; prefec ber high alarm flag
    prefecberlowalarm_flag       = FLOAT                            ; prefec ber low alarm flag
    prefecberhighwarning_flag    = FLOAT                            ; prefec ber high warning flag
    prefecberlowwarning_flag     = FLOAT                            ; prefec ber low warning flag
    postfecberhighalarm_flag     = FLOAT                            ; postfec ber high alarm flag
    postfecberlowalarm_flag      = FLOAT                            ; postfec ber low alarm flag
    postfecberhighwarning_flag   = FLOAT                            ; postfec ber high warning flag
    postfecberlowwarning_flag    = FLOAT                            ; postfec ber low warning flag
    biasxihighalarm_flag         = FLOAT                            ; bias xi high alarm flag
    biasxilowalarm_flag          = FLOAT                            ; bias xi low alarm flag
    biasxihighwarning_flag       = FLOAT                            ; bias xi high warning flag
    biasxilowwarning_flag        = FLOAT                            ; bias xi low warning flag
    biasxqhighalarm_flag         = FLOAT                            ; bias xq high alarm flag
    biasxqlowalarm_flag          = FLOAT                            ; bias xq low alarm flag
    biasxqhighwarning_flag       = FLOAT                            ; bias xq high warning flag
    biasxqlowwarning_flag        = FLOAT                            ; bias xq low warning flag
    biasxphighalarm_flag         = FLOAT                            ; bias xp high alarm flag
    biasxplowalarm_flag          = FLOAT                            ; bias xp low alarm flag
    biasxphighwarning_flag       = FLOAT                            ; bias xp high warning flag
    biasxplowwarning_flag        = FLOAT                            ; bias xp low warning flag
    biasyihighalarm_flag         = FLOAT                            ; bias yi high alarm flag
    biasyilowalarm_flag          = FLOAT                            ; bias yi low alarm flag
    biasyihighwarning_flag       = FLOAT                            ; bias yi high warning flag
    biasyilowwarning_flag        = FLOAT                            ; bias yi low warning flag
    biasyqhighalarm_flag         = FLOAT                            ; bias yq high alarm flag
    biasyqlowalarm_flag          = FLOAT                            ; bias yq low alarm flag
    biasyqhighwarning_flag       = FLOAT                            ; bias yq high warning flag
    biasyqlowwarning_flag        = FLOAT                            ; bias yq low warning flag
    biasyphighalarm_flag         = FLOAT                            ; bias yp high alarm flag
    biasyplowalarm_flag          = FLOAT                            ; bias yp low alarm flag
    biasyphighwarning_flag       = FLOAT                            ; bias yp high warning flag
    biasyplowwarning_flag        = FLOAT                            ; bias yp low warning flag
    cdshorthighalarm_flag        = FLOAT                            ; cd short high alarm flag
    cdshortlowalarm_flag         = FLOAT                            ; cd short low alarm flag
    cdshorthighwarning_flag      = FLOAT                            ; cd short high warning flag
    cdshortlowwarning_flag       = FLOAT                            ; cd short low warning flag
    cdlonghighalarm_flag         = FLOAT                            ; cd long high alarm flag
    cdlonglowalarm_flag          = FLOAT                            ; cd long low alarm flag
    cdlonghighwarning_flag       = FLOAT                            ; cd long high warning flag
    cdlonglowwarning_flag        = FLOAT                            ; cd long low warning flag
    dgdhighalarm_flag            = FLOAT                            ; dgd high alarm flag
    dgdlowalarm_flag             = FLOAT                            ; dgd low alarm flag
    dgdhighwarning_flag          = FLOAT                            ; dgd high warning flag
    dgdlowwarning_flag           = FLOAT                            ; dgd low warning flag
    sopmdhighalarm_flag          = FLOAT                            ; sopmd high alarm flag
    sopmdlowalarm_flag           = FLOAT                            ; sopmd low alarm flag
    sopmdhighwarning_flag        = FLOAT                            ; sopmd high warning flag
    sopmdlowwarning_flag         = FLOAT                            ; sopmd low warning flag
    pdlhighalarm_flag            = FLOAT                            ; pdl high alarm flag
    pdllowalarm_flag             = FLOAT                            ; pdl low alarm flag
    pdlhighwarning_flag          = FLOAT                            ; pdl high warning flag
    pdllowwarning_flag           = FLOAT                            ; pdl low warning flag
    osnrhighalarm_flag           = FLOAT                            ; osnr high alarm flag
    osnrlowalarm_flag            = FLOAT                            ; osnr low alarm flag
    osnrhighwarning_flag         = FLOAT                            ; osnr high warning flag
    osnrlowwarning_flag          = FLOAT                            ; osnr low warning flag
    esnrhighalarm_flag           = FLOAT                            ; esnr high alarm flag
    esnrlowalarm_flag            = FLOAT                            ; esnr low alarm flag
    esnrhighwarning_flag         = FLOAT                            ; esnr high warning flag
    esnrlowwarning_flag          = FLOAT                            ; esnr low warning flag
    cfohighalarm_flag            = FLOAT                            ; cfo high alarm flag
    cfolowalarm_flag             = FLOAT                            ; cfo low alarm flag
    cfohighwarning_flag          = FLOAT                            ; cfo high warning flag
    cfolowwarning_flag           = FLOAT                            ; cfo low warning flag
    txcurrpowerhighalarm_flag    = FLOAT                            ; txcurrpower high alarm flag
    txcurrpowerlowalarm_flag     = FLOAT                            ; txcurrpower low alarm flag
    txcurrpowerhighwarning_flag  = FLOAT                            ; txcurrpower high warning flag
    txcurrpowerlowwarning_flag   = FLOAT                            ; txcurrpower low warning flag
    rxtotpowerhighalarm_flag     = FLOAT                            ; rxtotpower high alarm flag
    rxtotpowerlowalarm_flag      = FLOAT                            ; rxtotpower low alarm flag
    rxtotpowerhighwarning_flag   = FLOAT                            ; rxtotpower high warning flag
    rxtotpowerlowwarning_flag    = FLOAT                            ; rxtotpower low warning flag
    rxsigpowerhighalarm_flag     = FLOAT                            ; rxsigpower high alarm flag
    rxsigpowerlowalarm_flag      = FLOAT                            ; rxsigpower low alarm flag
    rxsigpowerhighwarning_flag   = FLOAT                            ; rxsigpower high warning flag
    rxsigpowerlowwarning_flag    = FLOAT                            ; rxsigpower low warning flag
