...
| | | last_updated_time | The last update time of this state in milliseconds. |
| | | last_update_error | The error code of last update. The semantics of the error code should follow the [SAI status code](https://github.com/opencomputeproject/SAI/blob/master/inc/saistatus.h). |
