...
| ***Base OS upgrade to Trixie*** | This update upgrades the base OS to Trixie, including core components such as the kernel and Docker daemon, to provide a more modern, stable, and secure operating environment. | [2040](https://github.com/sonic-net/SONiC/issues/2040) | [Alpha](https://github.com/sonic-net/SONiC/blob/master/doc/SONiC%20feature%20quality%20definition.md)  |
