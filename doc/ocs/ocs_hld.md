...
| --- | --- | --- | 
| src/sonic-gnmi |sonic-gnmi  | Use batch commit for OCS cross-connect configurations      | 
...
| src/sonic-mgmt-common | sonic-mgmt-common |  Update CVL for validation of OCS configuration    | 
